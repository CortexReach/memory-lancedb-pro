...
export interface RetrievalConfig {
   ...
   *  After retrieval, finds vector neighbors of each result in the same scope and merges.
   *  Only applies to auto-recall source to avoid adding latency to manual retrieval. (default: true) */
